...
const residences = [
  {
    ...
    // single image will be generated by getImagePath()
    images: null,
  },
  {
    id: 2,
...
const getImagePath = (name) => {
  ...
  const shortMap = {
    ...
    "squirengresidence": "squireng",   // fallback if images array is empty
  };
...
function Accommodation() {
  ...
  // track which image index is currently shown per residence
  ...
  // get the images array for a residence (single image as array if no explicit images)
  const getImages = (res) => {
    if (res.images && res.images.length > 0) return res.images;
    // fall back to the single generated path
