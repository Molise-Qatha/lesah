...
function computerMove(s) {
  ...
  const depth = 4; // VERY HARD always
      ...
      <div className="morabaraba-landing">
        <div className="morabaraba-landing-inner">
          ...
          <div className="difficulty-display">
            ...
            <span className="difficulty-value">VERY HARD</span>
            <span className="difficulty-note">Designed for players looking for the ultimate challenge.</span>
          </div>
